    ...
    <div class="flex-grow-1 overflow-y-auto">
            ...
            <div class="sidebar-menu-section">
                ...
                <ul class="sidebar-menu-list">
                    <li class="sidebar-menu-item">
                        <a href="{{ route('users.show', ['user' => auth()->user()->id]) }}" class="sidebar-menu-link  {{ activeLink('users.show') }}"
                    ...
                    <li class="sidebar-menu-item">
                        <a href="{{ route('users.edit', ['user' => auth()->user()->id]) }}" class="sidebar-menu-link  {{ activeLink('users.edit') }}"
                            id="menu-overview" title="Overview">
        ...
        @if (auth()->user()->role_id != 5)
            <div class="sidebar-menu-section">
                ...
                <ul class="sidebar-menu-list">
                    <li class="sidebar-menu-item">
                        <a href="{{ route('dashboard') }}" class="sidebar-menu-link  {{ activeLink('dashboard') }}"
                            id="menu-overview" title="Overview">
            ...
            <div class="sidebar-menu-section">
                ...
                <ul class="sidebar-menu-list">
                    <li class="sidebar-menu-item">
                        <a href="{{ route('users.index') }}" class="sidebar-menu-link {{ activeLink('users*') }}"
